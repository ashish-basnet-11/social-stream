...
const Register = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-50 p-4 sm:p-6 lg:p-8">
      <Snowfall color='#FECDD3' />
      <div className="flex flex-col lg:flex-row-reverse w-full max-w-6xl bg-white rounded-[32px] shadow-2xl shadow-slate-200 overflow-hidden min-h-[700px] border border-slate-100">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-slate-50 p-12 flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            <h2 className="text-5xl font-black text-slate-900 mb-6 self-start tracking-tighter leading-[1.1]">
              See what <br />
              <span className="text-rose-600">is happening.</span>
            </h2>
          ...
          <div className="absolute bottom-1/4 -right-20 w-80 h-80 bg-indigo-100 rounded-full filter blur-[100px] opacity-40 -z-0"></div>
        </div>
