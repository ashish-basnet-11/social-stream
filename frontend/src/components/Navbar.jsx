        ...
        <header className="fixed top-0 left-0 right-0 h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 z-50 px-6">
            <div className="max-w-[1600px] mx-auto h-full flex items-center justify-between">
                ...
                <Link to="/" className="flex items-center gap-3 lg:w-52">
                    <div className="h-9 w-9 bg-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-200 shrink-0">
                                        ...
                                        return (
                                            <div key={u.id} className="group/item flex items-center justify-between p-3 hover:bg-indigo-50/50 rounded-[20px] transition-all">
                                                <Link to={`/profile/${u.id}`} className="flex items-center gap-3 flex-1" onClick={() => setIsSearching(false)}>
                                                    ...
                                                    <div>
                                                        <p className="text-xs font-black uppercase tracking-tight italic text-slate-800 group-hover/item:text-indigo-600 transition-colors">{u.name}</p>
                                                        <div className="flex items-center gap-2">
                                                            <span className="opacity-0 group-hover/item:opacity-100 text-[9px] font-black text-indigo-400 uppercase transition-opacity tracking-tighter">View Profile →</span>
                                                        </div>
                                                    </div>
                                                </Link>
