...
const SidebarLink = ({ to, icon, label, active }) => (
  ...
  >
    <div className={`p-2 rounded-lg transition-all shrink-0 ${
      active ? 'bg-indigo-600 text-white shadow-md shadow-indigo-100' : 'group-hover:bg-slate-100'
    }`}>
      {icon}
    </div>
    <span className={`hidden lg:block font-bold text-[13px] uppercase tracking-tight ${
